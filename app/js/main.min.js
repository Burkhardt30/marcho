...
$(function(){$(".shop-content__filter-btn").on("click",function(){$(".shop-content__filter-btn").removeClass("shop-content__filter-btn--active"),$(this).addClass("shop-content__filter-btn--active")}),$(".content-list").on("click",function(){$(".products-item").addClass("products-item--list")}),$(".content-grid").on("click",function(){$(".products-item").removeClass("products-item--list")}),$(".shop-content__styler, .product-item__number").styler({}),$(".filter-price__input").ionRangeSlider({type:"double",onStart:function(e){$(".filter-price__from").text(e.from),$(".filter-price__to").text(e.to)},onChange:function(e){$(".filter-price__from").text(e.from),$(".filter-price__to").text(e.to)}}),$(".main-silder__inner").slick({arrows:!1,dots:!0,fade:!0,autoplay:!0,autoplaySpeed:5e3,speed:1e3}),$(".product-slider__small").slick({asNavFor:".product-slider__big",slidesToShow:4,slidesToScroll:1,vertical:!0,arrows:!1,draggable:!1}),$(".product-slider__big").slick({asNavFor:".product-slider__small",slidesToShow:1,slidesToScroll:1,fade:!0,arrows:!1,draggable:!1}),$(".stars").rateYo({starWidth:"17px",normalFill:"#ccccce",ratedFill:"#ffc35b",readOnly:!0,starSvg:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z"/></svg>'}),function s(e,l){var t=document.querySelector(".promo__countdown"),n=t.querySelector(".promo__days"),i=t.querySelector(".promo__hours"),c=t.querySelector(".promo__minutes"),a=t.querySelector(".promo__seconds");function o(){var e,t,o,r;(r=(e=l,t=Date.parse(e)-Date.parse(new Date),r=Math.floor(t/1e3%60),o=Math.floor(t/1e3/60%60),e=Math.floor(t/36e5%24),{total:t,days:Math.floor(t/864e5),hours:e,minutes:o,seconds:r})).total<=0&&(clearInterval(d),s(0,new Date(Date.parse(new Date)+6e3))),n.innerHTML=r.days,i.innerHTML=("0"+r.hours).slice(-2),c.innerHTML=("0"+r.minutes).slice(-2),a.innerHTML=("0"+r.seconds).slice(-2)}o();var d=setInterval(o,1e3)}(0,$(".promo__countdown").attr("data-time"))});