...
$(function(){$(".filter-price__input").ionRangeSlider({type:"double",onStart:function(e){$(".filter-price__from").text(e.from),$(".filter-price__to").text(e.to)},onChange:function(e){$(".filter-price__from").text(e.from),$(".filter-price__to").text(e.to)}}),$(".main-silder__inner").slick({arrows:!1,dots:!0,fade:!0,autoplay:!0,autoplaySpeed:5e3,speed:1e3}),$(".stars").rateYo({starWidth:"17px",normalFill:"#ccccce",ratedFill:"#ffc35b",readOnly:!0,starSvg:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z"/></svg>'}),function n(e,a){var t=document.querySelector(".promo__countdown"),l=t.querySelector(".promo__days"),c=t.querySelector(".promo__hours"),i=t.querySelector(".promo__minutes"),s=t.querySelector(".promo__seconds");function r(){var e,t,r,o;(o=(e=a,t=Date.parse(e)-Date.parse(new Date),o=Math.floor(t/1e3%60),r=Math.floor(t/1e3/60%60),e=Math.floor(t/36e5%24),{total:t,days:Math.floor(t/864e5),hours:e,minutes:r,seconds:o})).total<=0&&(clearInterval(_),n(0,new Date(Date.parse(new Date)+6e3))),l.innerHTML=o.days,c.innerHTML=("0"+o.hours).slice(-2),i.innerHTML=("0"+o.minutes).slice(-2),s.innerHTML=("0"+o.seconds).slice(-2)}r();var _=setInterval(r,1e3)}(0,$(".promo__countdown").attr("data-time"))});