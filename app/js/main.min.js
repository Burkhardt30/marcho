...
$(function(){$(".shop__show-filters").on("click",function(){$(".shop__filters").toggleClass("shop__filters--show")}),$(".footer__title--open").on("click",function(){$(this).next().slideToggle(),$(this).toggleClass("footer__title--arrow")}),$(".burger-btn").on("click",function(){$(".menu__list").toggleClass("menu__list--active"),$(".blackout").toggleClass("blackout--active")}),$(".blog-item__slider").slick({prevArrow:'<button type="button" class="slick-prev"><svg xmlns="http://www.w3.org/2000/svg" width="7pt" height="14pt" viewBox="0 0 7 14" version="1.1"><g><path d="M 0.867188 6.535156 L 4.585938 2.816406 C 4.84375 2.558594 5.257812 2.558594 5.511719 2.816406 L 6.128906 3.433594 C 6.386719 3.691406 6.386719 4.105469 6.128906 4.359375 L 3.496094 7 L 6.132812 9.636719 C 6.390625 9.894531 6.390625 10.308594 6.132812 10.5625 L 5.515625 11.183594 C 5.257812 11.441406 4.84375 11.441406 4.589844 11.183594 L 0.871094 7.464844 C 0.609375 7.207031 0.609375 6.792969 0.867188 6.535156 Z M 0.867188 6.535156 "/></g></svg></button>',nextArrow:'<button type="button" class="slick-next"><svg xmlns="http://www.w3.org/2000/svg" width="7pt" height="14pt" viewBox="0 0 7 14" version="1.1"><g><path d="M 6.132812 7.464844 L 2.414062 11.183594 C 2.15625 11.441406 1.742188 11.441406 1.488281 11.183594 L 0.871094 10.566406 C 0.613281 10.308594 0.613281 9.894531 0.871094 9.640625 L 3.503906 7.003906 L 0.871094 4.367188 C 0.613281 4.109375 0.613281 3.695312 0.871094 3.441406 L 1.484375 2.816406 C 1.742188 2.558594 2.15625 2.558594 2.410156 2.816406 L 6.128906 6.535156 C 6.390625 6.792969 6.390625 7.207031 6.132812 7.464844 Z M 6.132812 7.464844 "/></g></svg></button>',infinite:!1}),$(".product-tabs__top-item").on("click",function(t){t.preventDefault(),$(".product-tabs__top-item").removeClass("product-tabs__top-item--active"),$(this).addClass("product-tabs__top-item--active"),$(".product-tabs__content-item").removeClass("product-tabs__content-item--active"),$($(this).attr("href")).addClass("product-tabs__content-item--active")}),$(".shop-content__filter-btn").on("click",function(){$(".shop-content__filter-btn").removeClass("shop-content__filter-btn--active"),$(this).addClass("shop-content__filter-btn--active")}),$(".content-list").on("click",function(){$(".products-item").addClass("products-item--list"),$(".shop-content__inner").addClass("shop-content__inner--flex")}),$(".content-grid").on("click",function(){$(".products-item").removeClass("products-item--list"),$(".shop-content__inner").removeClass("shop-content__inner--flex")}),$(".shop-content__styler, .product-item__number").styler({}),$(".filter-price__input").ionRangeSlider({type:"double",onStart:function(t){$(".filter-price__from").text(t.from),$(".filter-price__to").text(t.to)},onChange:function(t){$(".filter-price__from").text(t.from),$(".filter-price__to").text(t.to)}}),$(".main-silder__inner").slick({arrows:!1,dots:!0,fade:!0,autoplay:!0,autoplaySpeed:5e3,speed:1e3}),$(".product-slider__small").slick({asNavFor:".product-slider__big",slidesToShow:4,slidesToScroll:1,vertical:!0,arrows:!1,draggable:!1,focusOnSelect:!0,responsive:[{breakpoint:1200,settings:{vertical:!1}}]}),$(".product-slider__big").slick({asNavFor:".product-slider__small",slidesToShow:1,slidesToScroll:1,fade:!0,arrows:!1,draggable:!1,responsive:[{breakpoint:1e3,settings:{draggable:!0}}]}),$(".stars").rateYo({starWidth:"17px",normalFill:"#ccccce",ratedFill:"#ffc35b",readOnly:!0,starSvg:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z"/></svg>'}),function r(t,n){var e=document.querySelector(".promo__countdown"),i=e.querySelector(".promo__days"),l=e.querySelector(".promo__hours"),c=e.querySelector(".promo__minutes"),a=e.querySelector(".promo__seconds");function o(){var t,e,o,s;(s=(t=n,e=Date.parse(t)-Date.parse(new Date),s=Math.floor(e/1e3%60),o=Math.floor(e/1e3/60%60),t=Math.floor(e/36e5%24),{total:e,days:Math.floor(e/864e5),hours:t,minutes:o,seconds:s})).total<=0&&(clearInterval(_),r(0,new Date(Date.parse(new Date)+6e3))),i.innerHTML=s.days,l.innerHTML=("0"+s.hours).slice(-2),c.innerHTML=("0"+s.minutes).slice(-2),a.innerHTML=("0"+s.seconds).slice(-2)}o();var _=setInterval(o,1e3)}(0,$(".promo__countdown").attr("data-time"))});