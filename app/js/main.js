$(function () {
  ...
  $('.shop__show-filters').on('click', function(){
    $('.shop__filters').toggleClass('shop__filters--show');
  });

  $('.footer__title--open').on('click', function(){
    $(this).next().slideToggle();
    $(this).toggleClass('footer__title--arrow');
  });
